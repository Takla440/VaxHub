    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <?php if($_SESSION["role"] == "1")
                  ...
                  ?>
            <a type="button" class="btn btn-outline-primary m-2" href="addvaccine.php"><i class="fa fa-syringe me-2"></i>Add Vaccine</a>
            <?php  }?>
        </div>
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">Vaccine Availablity </th>
                  ...
                  ?>
                    <a href="vaccinedit.php?id=<?php echo $row["id"] ?>" type="button" class="btn btn-outline-warning btn-sm">Edit</a>
                    <a href="vaccinedelete.php?id=<?php echo $row["id"] ?>" onclick="return confirm ('Are You Sure?'); " type="button" class="btn btn-outline-danger btn-sm">Delete</a>
                  <?php } ?>
                  </td>
