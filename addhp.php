                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Hospital Form</h6>
                            <form method="post">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1" name="hpemail">

                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputPassword1" class="form-label">Login Password</label>
                                    <input type="text" class="form-control" id="exampleInputPassword1" name="hppass">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputPassword1" class="form-label">Hospital Address</label>
<!-- Change the name attribute from hpadress to hpaddress -->
<textarea type="text" class="form-control" id="exampleInputPassword1" name="hpaddress"></textarea>
                                </div>

                                <button type="submit" class="btn btn-outline-primary m-2" name="btn_submit"><i class="fa fa-plus me-2"></i>Add Hospital</button>
                            </form>
                        </div>
                    </div>
...
if(isset($_POST["btn_submit"]))
{
  ...
  $sql = "insert into hospital (name,city,address,email,pass) values ('".$name."','".$fname."','".$_POST["hpaddress"]."','".$_POST["hpemail"]."','".$_POST["hppass"]."')";
