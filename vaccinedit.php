...
if(isset($_SESSION['user']))
{
    ...
    include "connect.php";
$sql = "select * from vaccine where id = '".$_GET ["id"]."'";
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Update Vaccine</h6>
                            <form method="post">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputPassword1" value="<?php echo $result["quantity"] ?>"name="fname">
                                </div>
                                
                                
                                
                                
                                <button type="submit" class="btn btn-outline-primary m-2" name="btn_submit"><i class="fa fa-refresh me-2"></i>Update Vaccine</button>
                            </form>
                        </div>
                    </div>
...
if(isset($_POST["btn_submit"]))
{
  ...
  $sql = "update vaccine set name = '".$name."' ,quantity = '".$fname."' where id = '".$_GET['id']."'";
  echo $sql;
