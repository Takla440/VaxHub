    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <?php if($_SESSION["role"] == "3")
                  ...
                  ?>
            <a type="button" class="btn btn-outline-primary m-2" href="addchild.php"><i class="fa fa-plus me-2"></i>Add Child</a>
            <?php  }?>
        </div>
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">Birth Of Place</th>
                  ...
                  ?>
                    <a href="childedit.php?id=<?php echo $row["id"] ?>" type="button" class="btn btn-outline-warning btn-sm">Edit</a>
                    <a href="childdelete.php?id=<?php echo $row["id"] ?>" onclick="return confirm ('Are You Sure?'); " type="button" class="btn btn-outline-danger btn-sm">Delete</a>
                  <?php } ?>
                  </td>
