...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <h6 class="mb-4">Hospital Details</h6>
            <?php if($_SESSION["role"] == "1")
                    {
                        
                  ?>
            <a type="button" class="btn btn-outline-primary m-2" href="addhp.php"><i class="fa fa-hospital me-2"></i>Add Hospital</a>
            <?php  }?>
        </div>
                  ...
                  ?>
                    <a href="hospitaledit.php?id=<?php echo $row["id"] ?>" type="button" class="btn btn-outline-warning btn-sm">Edit</a>
                    <a href="hospitaldelete.php?id=<?php echo $row["id"] ?>" onclick="return confirm ('Are You Sure?'); " type="button" class="btn btn-outline-danger btn-sm">Delete</a>
                  <?php } ?>
                  </td>
