                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Vaccination Form</h6>
                            <form method="post">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="exampleInputPassword1" name="fname">
                                </div>

                                <button type="submit" class="btn btn-outline-primary m-2" name="btn_submit"><i class="fa fa-syringe me-2"></i>Add Vaccine</button>
                            </form>
                        </div>
                    </div>
...
if(isset($_POST["btn_submit"]))
{
  ...
  $sql = "insert into vaccine (name,quantity) values ('".$name."','".$fname."')";
