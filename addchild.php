                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form method="post">
                                ...
                                <button type="submit" class="btn btn-outline-primary m-2" name="btn_submit"><i class="fa fa-plus me-2"></i>Add Child</button>
                            </form>
                        </div>
                    </div>
...
if(isset($_POST["btn_submit"]))
{
  ...
  $sql = "insert into child (name,fname,dob,pob,city,parentid) values ('".$name."','".$_SESSION["user"]."','".$dob."','".$pob."','".$city."','".$_SESSION["userid"]."')";
  echo $sql;
