                  ...
                  {?>
                      ...
                      <?php }?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="exampleInputPassword1" name="dov">
                                </div>
...
if(isset($_POST["btn_submit"]))
{
  ...
  $sql = "insert into upcomingvaccine(vname,hname,date) values ('".$_POST["vaccine"]."','".$_POST["hospital"]."','".$_POST["dov"]."')";
